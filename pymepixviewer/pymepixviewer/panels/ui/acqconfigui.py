...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.write_flashID = QtWidgets.QCheckBox(self.groupBox_3)
        self.write_flashID.setChecked(True)
        self.write_flashID.setObjectName("write_flashID")
        self.horizontalLayout.addWidget(self.write_flashID)
    ...
    def retranslateUi(self, Form):
        ...
        self.write_flashID.setText(_translate("Form", "BunchId"))
